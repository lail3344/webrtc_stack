...
// added by luqiang
struct VCMEncodeFrameInformation
{
    int64_t     encodeStartTimeMs;
    void*       userData;
};
...
public:
    ...
    */
    ...
    // added by luqiang
    int32_t Map(uint32_t timestamp, VCMEncodeFrameInformation* frameInfo);
...
private:
    ...
    VCMTimestampMap _encodeTimestampMap;
...
private:
    ...
    bool                        _internalSource;
    // added by luqiang
    VCMEncodeFrameInformation         _frameInfos[10];
    uint32_t              _nextFrameInfoIdx;
    VCMEncodedFrameCallback*    _callback;
